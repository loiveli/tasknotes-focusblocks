...
export const en: TranslationTree = {
	...
	settings: {
		...
		features: {
			...
			focusBlocks: {
				...
				enableName: "Enable Focus Blocks",
				enableDesc: "Turn on the Focus Block feature in the calendar.",
				showByDefaultName: "Show Focus Blocks by default",
				showByDefaultDesc: "Display Focus Blocks in calendar views when the feature is enabled.",
				defaultColorName: "Default Focus Block color",
				defaultColorDesc: "Default calendar color for newly created Focus Blocks.",
				showTasksOnAllName: "Show tasks on all Focus Blocks",
				showTasksOnAllDesc: "When off, task previews are only shown on the currently active Focus Block in the calendar. Opening the block still shows all tasks in the modal.",
			},
			performance: {
	...
	modals: {
		...
		focusBlockCreation: {
			heading: "Create Focus Block",
			dateLabel: "Date: ",
			titleLabel: "Title",
			titleDesc: "Name for this Focus Block",
			titlePlaceholder: "Morning Focus",
			startTimeLabel: "Start time",
			endTimeLabel: "End time",
			timeNote: "Tip: any minute is allowed, and the end time can go past midnight.",
			recurrenceLabel: "Recurrence",
			recurrenceDesc: "Reuse the same recurrence UI and logic as TaskNotes tasks",
			filterTagLabel: "Filter tag",
			filterTagDesc: "Optional tag to limit which tasks appear in this Focus Block",
			filterTagPlaceholder: "work",
			topTasksLabel: "Top tasks",
			topTasksDesc: "How many priority tasks to surface before showing overdue tasks",
			descriptionLabel: "Description",
			descriptionDesc: "Optional notes for this Focus Block",
			colorLabel: "Color",
			colorDesc: "Calendar color for this Focus Block",
			createButton: "Create Focus Block",
			notices: {
				invalidRange: "Please provide a valid title and time range",
				success: "Focus Block created",
				failure: "Failed to create Focus Block",
			},
		},
		focusBlockInfo: {
			heading: "Edit Focus Block",
			dateTimeLabel: "Date/time: ",
			dateTimeValue: "{date} from {startTime} to {endTime}",
			titleLabel: "Title",
			scheduledDateLabel: "Scheduled date",
			scheduledDateDesc: "Date this Focus Block is anchored to",
			startTimeLabel: "Start time",
			endTimeLabel: "End time",
			timeNote: "Tip: any minute is allowed, and the end time can go past midnight.",
			recurrenceLabel: "Recurrence",
			...
			deleteConfirmation: 'Delete Focus Block "{title}"?',
			notices: {
				taskFileMissing: "Could not find task file",
				updateSuccess: "Focus Block updated",
				updateFailure: "Failed to save Focus Block",
				deleteSuccess: "Focus Block deleted",
				deleteFailure: "Failed to delete Focus Block",
			},
		},
	...
	focusBlocks: {
		...
		actions: {
			createFromCalendar: "Create Focus Block",
			createTask: "Create task",
		},
		preview: {
			...
			moreOverdueTasks: "+{count} overdue tasks",
			unableToLoadTasks: "Unable to load tasks",
		},
		notices: {
			timeRangeRequired:
				"Focus Blocks must have a specific time range. Please select time in day or week view.",
			moved: "Focus Block moved",
			updated: "Focus Block updated",
			moveFailed: "Failed to move Focus Block: {message}",
			resizeFailed: "Failed to resize Focus Block: {message}",
		},
	},
	components: {
		dateContextMenu: {
